...
ctx.fillRect(600,100,500,500); //畫了一個座標為(300,100)的500px * 500px的矩形
ctx.clearRect(700,150,100,100); //再清除一個座標為(400,150)的100px * 100px的矩形形狀
ctx.strokeRect(725,175,50,50); //最後畫一個座標為(425,175)的50px * 50px的矩形邊框
ctx.clearRect(900,150,100,100); //再清除一個座標為(600,150)的100px * 100px的矩形形狀
ctx.strokeRect(925,175,50,50); //最後畫一個座標為(425,175)的50px * 50px的矩形邊框
ctx.clearRect(800,400,100,100); //再清除一個座標為(500,400)的100px * 100px的矩形形狀
...
ctx.fillText("第一行文字Hello world", 300, 50);  //填滿文字
ctx.strokeText("第二行框框文字Hello text", 300, 100); //邊框文字
ctx.fillText("第三行被壓縮的文字", 300, 150, 100);  //壓縮文字
